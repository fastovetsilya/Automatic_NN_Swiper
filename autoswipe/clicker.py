...
class Clicker():
    ...
    def positions(self):
        while True:
            ...
            yes_position = pyautogui.locateOnScreen(
                os.getcwd() + '/icons/' + 'yes.png')
            no_position = pyautogui.locateOnScreen(
                os.getcwd() + '/icons/' + 'no.png')
    ...
    def initialize_model(self):
        model = load_model('trained_model.h5',
                           custom_objects={'matthews_correlation': Model.matthews_correlation})
        self.model = model
